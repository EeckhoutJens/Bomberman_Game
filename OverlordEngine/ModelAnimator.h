...
public:
	...
	void SetAnimation(std::wstring clipName, bool playOnce = false);
	void SetAnimation(UINT clipNumber, bool playOnce = false);
	void SetAnimation(AnimationClip clip, bool playOnce = false);
	void Update(const GameContext& gameContext);
	void Reset(bool pause = true);
	void Play() { m_IsPlaying = true; }
	bool GetPlayOnce() { return m_PlayOnce; }
...
private:
	...
	bool m_IsPlaying, m_Reversed, m_ClipSet, m_PlayOnce;
