...
public:
	...
	void ChangeLeftThumbDeadzone(float deadZone) { m_LeftThumbDeadzone = deadZone; }
	void ChangeRightThumnDeadzone(float deadZone) { m_RightThumbDeadzone = deadZone; }
	void Update();
	bool AddInputAction(InputAction action, bool forceAdd = false);
	...
	static void StopVibration(GamepadIndex playerIndex = GamepadIndex::PlayerOne);
...
private:
	...
	static float m_LeftThumbDeadzone;
	static float m_RightThumbDeadzone;
};