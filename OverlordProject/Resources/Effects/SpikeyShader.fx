...
void SpikeGenerator(triangle VS_DATA vertices[3], inout TriangleStream<GS_DATA> triStream)
{
    ...
    float3 basePoint, baseNormal, top, left, right, spikeNormal, spikeDirection;
    ...
    top = basePoint + (baseNormal * 4);

    //Step 4. Calculate The Left And Right Positions
    spikeDirection = (vertices[2].Position - vertices[0].Position) * 0.1f;
