...
void CreateVertex(inout TriangleStream<GS_DATA> triStream, float3 pos, float2 texCoord, float4 col, float2x2 uvRotation)
{
    ...
    geom.Position = mul(float4(pos, 1), gWorldViewProj);
...
void MainGS(point VS_DATA vertex[1], inout TriangleStream<GS_DATA> triStream)
{
    ...
    //float3x3 convertedInverse = float3x3(gViewInverse._11, gViewInverse._12, gViewInverse._13, gViewInverse._21, gViewInverse._22, gViewInverse._23, gViewInverse._31, gViewInverse._32, gViewInverse._33);
