...
#ifdef Exam
#include "CourseObjects/Exam/Scenes/TitleScreen.h"
#include "CourseObjects/Exam/Scenes/ControlScreen.h"
#include "CourseObjects/Exam/Scenes/ExamScene.h"
#include "CourseObjects/Exam/Scenes/CreditsScene.h"
#include "CourseObjects/Exam/Scenes/KeyboardControlScreen.h"
#endif
...
void MainGame::Initialize()
{
	...
	SceneManager::GetInstance()->SetActiveGameScene(L"ComponentTestScene");
#endif
	...
	SceneManager::GetInstance()->AddGameScene(new ParticleScene());
	SceneManager::GetInstance()->AddGameScene(new PostProcessingScene());
	SceneManager::GetInstance()->AddGameScene(new TitleScreen());
	SceneManager::GetInstance()->AddGameScene(new ControlScreen());
	...
	SceneManager::GetInstance()->AddGameScene(new KeyboardControlScreen());
	SceneManager::GetInstance()->AddGameScene(new ControlScreen());
	SceneManager::GetInstance()->AddGameScene(new ExamScene());
	SceneManager::GetInstance()->AddGameScene(new CreditsScene());
